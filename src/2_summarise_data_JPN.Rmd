---
title: "Donor iron supplement perception data summary JPN"
...
#run code below in console:
 # rmarkdown::render('L:/DonorMedicin/FORTE/E Internation Donor Perception Survey/B Analysis/R/1. R Scripts/src/2_summarise_data_JPN.Rmd', clean=TRUE,output_format='html_document',output_file='L:/DonorMedicin/FORTE/E Internation Donor Perception Survey/B Analysis/R/4. Results/summarise_data_JPN.html') 
...
data <- readRDS("L:/DonorMedicin/FORTE/E Internation Donor Perception Survey/A Source documents/iDPS - JPN/dataJPN.rds")
...
questions <- questions %>% filter(JPN == "x")
