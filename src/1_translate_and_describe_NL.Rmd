...
names(data) <- gsub("^Q19_1$", "Symptoms2", names(data))
names(data) <- gsub("^Q19_2$", "Symptoms3", names(data))
names(data) <- gsub("^Q19_3$", "Symptoms5", names(data))
names(data) <- gsub("^Q19_4$", "Symptoms6", names(data))
names(data) <- gsub("^Q19_5$", "Symptoms8", names(data))
names(data) <- gsub("^Q19_6$", "Symptoms9", names(data))

names(data) <- gsub("^Q82_1$", "Symptoms2_Severity", names(data))
names(data) <- gsub("^Q82_2$", "Symptoms3_Severity", names(data))
names(data) <- gsub("^Q82_3$", "Symptoms5_Severity", names(data))
names(data) <- gsub("^Q82_4$", "Symptoms6_Severity", names(data))
names(data) <- gsub("^Q82_5$", "Symptoms8_Severity", names(data))
names(data) <- gsub("^Q82_6$", "Symptoms9_Severity", names(data))
...
data <- data %>% mutate_at(vars(matches("^SymptomsID[1-6]$")), ~ ifelse(SymptomsID9 == 1, 1, .))
...
tmp <- data %>% 
  ...
  mutate_at(vars(which(colnames(data) %in% c("Symptoms1", "Symptoms2", "Symptoms3", "Symptoms4", "Symptoms5", "Symptoms6", "Symptoms7", "Symptoms8", "Symptoms9"))), ~ f2(.)) %>% 
