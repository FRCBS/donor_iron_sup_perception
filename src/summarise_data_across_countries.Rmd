...
datafi <- readRDS("L:/DonorMedicin/FORTE/E Internation Donor Perception Survey/B Analysis/R/2. Datasets/1. iDPS - Summary data - NL.RDS") #
...
p <- ggplot(qdata) + 
  ...
  scale_fill_manual(values = c("FI" = "deepskyblue", "NL" = "darkorange1"))+
  theme_bw()+
