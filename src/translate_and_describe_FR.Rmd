...
names(data) <- gsub("Dietary advice", "LowIron_Preference1", names(data))
names(data) <- gsub("Provision of iron supplements", "LowIron_Preference1", names(data))
names(data) <- gsub("Stop donations", "LowIron_Preference1", names(data))
